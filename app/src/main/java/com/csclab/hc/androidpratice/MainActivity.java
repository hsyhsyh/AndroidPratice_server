    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ipSend.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d("MainActivity","Client Send");
                Thread t = new thread();
                t.start();
                jumpToMainLayout();
            }
...
//    }
    ...
    class thread extends Thread{
        public void run(){
            try{
               System.out.println("MainActivity: Waiting to connect...");
                int serverPort = 2000;
...
//                }
    ...
    public void sendmessage(String m)
    {
        ...
        try {
            ...
            byte[] sendStrByte = new byte[1024];
            System.arraycopy(m.getBytes(), 0, sendStrByte, 0, m.length());
            out.write(sendStrByte);
        } catch (IOException e) {
            e.printStackTrace();
        }
